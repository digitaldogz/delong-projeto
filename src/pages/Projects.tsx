...
const ProjectsPage = () => {
  return (
    <div className="w-full bg-background text-foreground min-h-screen font-sans selection:bg-foreground selection:text-background">
      ...
      {/* NAVBAR */}
      <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-8 py-6 bg-background/50 backdrop-blur-md border-b border-border/5">
        <Link to="/" className="text-sm font-bold uppercase tracking-widest hover:opacity-70 transition-opacity flex items-center gap-2">
          ← Voltar para Home
        </Link>
        <img src={logoDelongWhite} alt="Delong Media House" className="h-10 w-auto" />
      </nav>
