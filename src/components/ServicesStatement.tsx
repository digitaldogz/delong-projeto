...
const ServicesStatement = () => {
  return (
    <section className="w-full bg-background py-32 md:py-48 px-6 md:px-12 flex flex-col items-center justify-center text-center border-t border-border">
      ...
      {/* Texto Principal */}
      <h2 className="max-w-5xl text-4xl md:text-6xl lg:text-7xl font-medium text-foreground leading-[1.1] tracking-tight mb-16">
