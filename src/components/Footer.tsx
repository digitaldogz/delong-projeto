        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 py-16 md:py-24">
          ...
          <div className="flex flex-col justify-between lg:border-l lg:border-border lg:pl-16">
            ...
            <div className="mt-12 flex justify-start gap-8">
              <a href="https://www.instagram.com/cesardelong/" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                <Instagram size={24} />
              </a>
              <a href="https://wa.me/5542999277578" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
